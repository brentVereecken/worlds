...
EncounterDetailsDB = {
	["emotes"] = {
		...
		}, -- [1]
		{
			{
				32.87100000001374, -- [1]
				" |TInterface\\Icons\\ability_creature_disease_02.blp:16|t You have been infected by |cFFBC05FFNecrotic Plague|r! |TInterface\\Icons\\ability_creature_disease_02.blp:16|t", -- [2]
				"Chinees", -- [3]
				2, -- [4]
			}, -- [1]
			{
