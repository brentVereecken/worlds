...
function JojoMonkPanel_Close()
	...
	if(L_UIDropDownMenu_GetText(JojoMonk_CharacterDropDown) ~= L['no_addon_load']) then
		JojoMonk_Config.ActiveCharacter = L_UIDropDownMenu_GetText(JojoMonk_CharacterDropDown);
	else
		L_UIDropDownMenu_SetText(JojoMonk_CharacterDropDown, JojoMonk_Config.ActiveCharacter);
	end
...
function JojoMonk_Initialise()
	...
	CreateFrame("Frame", "JojoMonk_CharacterDropDown", JojoMonkGUIFrame, "L_UIDropDownMenuTemplate");
	L_UIDropDownMenu_Initialize(JojoMonk_CharacterDropDown, JojoMonk_CharacterDropDown_Init);
	L_UIDropDownMenu_JustifyText(JojoMonk_CharacterDropDown, "LEFT");
	L_UIDropDownMenu_SetWidth(JojoMonk_CharacterDropDown, 150);
	L_UIDropDownMenu_SetText(JojoMonk_CharacterDropDown, JojoMonk_Config.ActiveCharacter);
...
function JojoMonk_CharacterDropDown_Init(self)
	...
	--
	local ddtext = L_UIDropDownMenu_GetText(JojoMonk_CharacterDropDown);
	...
	for index, filename in ipairs(GetLocalCharacterListView()) do
		...
		info.func = function (self)
			...
			--
			L_UIDropDownMenu_SetText(JojoMonk_CharacterDropDown, self:GetText());
		end
